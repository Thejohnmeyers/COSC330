...
public class TicTacToeMeyers {
	public static void displayBoard(String[][] gameBoard)
	  ...
	  public static void main(String[] args) 
	  {
	    ...
	    /*
	     * here instead of using the "-" character for the gameboard I decided to use numbers and have them be much easier
	     * to replace so instead of having to input the column and row to take your turn all you have to do is simply enter the 
	     * number that you would like to put your token onto the board 
	     */
	    B[0][0] = "1"; 
	    B[0][1] = "2"; 
	    B[0][2] = "3";
	   ...
	   if (isWin(B) == true)
	   {
	     ...
	     System.out.println("Congratulations " + Token + " you won!");
	     System.out.println("Here is your winning game board " + Token);
	     displayBoard(B);
