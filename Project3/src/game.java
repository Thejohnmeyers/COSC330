...
public class game extends JPanel implements ActionListener {
    ...
    public class Circle {
		...
		*/
		...
		// your code here
			if(other.center_x + other.radius > center_x - radius && other.center_y - other.radius < center_y + radius) {
				System.out.println("Collision!");
				return true;
			} else if( other.center_x + other.radius > center_x - radius && other.center_y - other.radius > center_y + radius ) {
				System.out.println("Collision!");
				return true;
			} else if(other.center_x - other.radius < center_x +radius && other.center_y - other.radius < center_y + radius) {
				System.out.println("Collision!");
